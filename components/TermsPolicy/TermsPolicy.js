        ...
        <div className="container">
          <div className="rbt-daynamic-page-content center-width">
            <div className="rbt-dashboard-content rainbow-section-gap">
              <div className="banner-area">
                <div className="settings-area">
                  <h3 className="title text-center">Terms And Condition</h3>
                </div>
              </div>
              <div className="content-page">
                <div className="chat-box-list">
                  <div className="content">
                    <p className="terms-highlight text-center fs-5">
                    ...
                    <p>
                      Welcome to{" "}
                      <b className="terms-highlight">
                        Nine Avatars Technology Private Limited
                      </b>{" "}
                      (“Company”, “we”, “our”, “us”)!
                    </p>
                    <p>
                      ...
                      <b className="terms-highlight">https://cogno.co/</b>{" "}
                    ...
                    <p>
                      ...
                      Privacy Policy (“Agreements”). You acknowledge that you
                    ...
                    <p>
                      ...
                      <b className="terms-highlight">support@cogno.co</b> so we
                      can try to find a solution. These Terms apply to all
                    ...
                    <p>
                      ...
                      information we may send. However, you may opt out of
                    ...
                    <p>
                      ...
                      right to use any card(s) or other payment method(s) in
                    ...
                    <p>
                      ...
                      cycles will be set depending on the type of subscription
                      plan you select when purchasing a Subscription.
                    </p>
                    <p>
                      At the end of each Billing Cycle, your Subscription will
                      automatically renew under the exact same conditions unless
                      you cancel it or Nine Avatars Technology Private Limited
                      cancels it. You may cancel your Subscription renewal
                      either through your online account management page or by
                      contacting support@cogno.co customer support team.
                    </p>
                    <p>
                      A valid payment method is required to process the payment
                      for your subscription. You shall provide Nine Avatars
                      Technology Private Limited with accurate and complete
                      billing information that may include but not limited to
                      full name, address, state, postal or zip code, telephone
                      number, and a valid payment method information. By
                      submitting such payment information, you automatically
                      authorize Nine Avatars Technology Private Limited to
                    ...
                    <p>
                      ...
                      Nine Avatars Technology Private Limited reserves the right
                      to terminate your access to the Service with immediate
                      effect.
                    </p>
                    <p>
                      6. <b>Free Trial</b>
                    ...
                    <p>
                      Nine Avatars Technology Private Limited may, at its sole
                      discretion, offer a Subscription with a free trial for a
                    ...
                    <p>
                      ...
                      for Free Trial, you will not be charged by Nine Avatars
                      Technology Private Limited until Free Trial has expired.
                      On the last day of Free Trial period, unless you cancelled
                      your Subscription, you will be automatically charged the
                      applicable Subscription fees for the type of Subscription
                      you have selected.
                    </p>
                    <p>
                      At any time and without notice, Nine Avatars Technology
                      Private Limited reserves the right to (i) modify Terms of
                      Service of Free Trial offer, or (ii) cancel such Free
                      Trial offer.
                    </p>
                    <p>
                      7. <b>Fee Changes</b>
                    ...
                    <p>
                      Nine Avatars Technology Private Limited, in its sole
                      discretion and at any time, may modify Subscription fees
                      for the Subscriptions. Any Subscription fee change will
                      become effective at the end of the then-current Billing
                      Cycle.
                    </p>
                    <p>
                      Nine Avatars Technology Private Limited will provide you
                      with a reasonable prior notice of any change in
                    ...
                    <p>
                      ...
                      <b className="terms-highlight">30 days</b> of the original
                    ...
                    <p>
                      ...
                      of Nine Avatars Technology Private Limited or used with
                    ...
                    <ul>
                      ...
                      <p>
                        0.3. Use any manual process to monitor or copy any of
                        the material on Service or for any other unauthorized
                      ...
                      <p>
                        0.6. Attempt to gain unauthorized access to, interfere
                      ...
                      <p>
                        0.9. Otherwise attempt to interfere with the proper
                        working of Service.
                      </p>
                    </ul>
                    <p>
                    ...
                    <p>
                      ...
                      by all of the terms and conditions of Terms. If you are
                      not at least eighteen (18) years old, you are prohibited
                    ...
                    <p>
                      ...
                      will remain the exclusive property of Nine Avatars
                      Technology Private Limited and its licensors. Service is
                      ...
                      written consent of Nine Avatars Technology Private
                      Limited.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      please submit your claim via email to support@cogno.co,
                    ...
                    <ul>
                      ...
                      <p>
                        0.2. a description of the copyrighted work that you
                        claim has been infringed, including the URL (i.e., web
                        page address) of the location where the copyrighted work
                        exists or a copy of the copyrighted work;
                      </p>
                      <p>
                        0.3. identification of the URL or other specific
                        location on Service where the material that you claim is
                      ...
                      <p>
                        0.6. a statement by you, made under penalty of perjury,
                    ...
                    <p>
                      You may provide us either directly at support@cogno.co or
                      via third party sites and tools with information and
                    ...
                    <p>
                      ...
                      services that are not owned or controlled by Nine Avatars
                      Technology Private Limited.
                    </p>
                    <p>
                      Nine Avatars Technology Private Limited has no control
                      over, and assumes no responsibility for the content,
                      privacy policies, or practices of any third party web
                      sites or services. We do not warrant the offerings of any
                    ...
                    <p>
                      ...
                      <a href="https://policymaker.io/">PolicyMaker.io</a>, a
                      free web application for generating high-quality legal
                    ...
                    <p>
                      ...
                      OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT
                      OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT
                      YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY
                    ...
                    <p>
                      ...
                      with the laws of Uttar Pradesh, India, which governing law
                    ...
                    <p>
                      ...
                      <b className="terms-highlight">support@cogno.co</b>.
                    </p>
                  </div>
                </div>
              </div>
